...
public class AppDb {
    ...
    private static StringBuilder responseStr = new StringBuilder("");
    private static String urlDb = "jdbc:mysql://localhost/cinemadb?serverTimezone=Europe/Kiev&useSSL=false&characterEncoding=UTF-8";
    ...
    public static StringBuilder sqlRequest(int valueOfOption, String requests) {
        ...
        String[] strQuery = new String[]{"select * from movies order by title;",
                ...
                "select title, genrename from moviegenres\n" +
                        ...
                        "\twhere genres.genrename = " + "'" + requests + "'" + ";",
    ...
    private static StringBuilder getFilmsSort(ResultSet rs) throws SQLException {
        ...
        if (responseStr.toString().equals("<ol>")) return new StringBuilder("Ничего не найдено по вашему запроссу");
