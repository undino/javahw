...
public class DynamicPageResponse extends StoreDbConnection {
    ...
    public String customerPage(Customer customer) {
        ...
        String response = "";
        String responseStart = "<!DOCTYPE html>" +
                "<html lang=\"en\">" +
                "<head>" +
                "<meta charset=\"UTF-8\">" +
                "<title>Title</title>" +
                ...
                "<p>Личный кабинет</p>" +
                "<div id=\"inner\">" +
                "<span id=\"login\">" + map.get("login") + "</span>" +
                "<span id=\"amount\">" + map.get("cash") + "</span>" +
                "<form method=\"post\" action=\"store\" id=\"store\">\n" +
                "            <input type=\"submit\" value=\"Магазин\">\n" +
                "            <input type=\"text\" name=\"login_for_store\" id=\"login_for_store\" value=\"" + map.get("login") + "\">\n" +
                "            <input type=\"text\" name=\"id_for_store\" id=\"password_for_store\" value=\"" + map.get("id") + "\">\n" +
                "            <input type=\"text\" name=\"password_for_store\" id=\"password_for_store\" value=\"" + map.get("password") + "\">\n" +
                "        </form>" +
                "<form method=\"post\" action=\"../index.html\" id=\"out\">\n" +
                "            <input type=\"submit\" value=\"Выйтм\">\n" +
                "</form>" +
    ...
    public String sellerPage(Seller seller) {
        ...
        String responseEnd = "</ol>" +
                ...
                "        </label>\n" +
                "        <input value=\"" + map.get("id") + "\" type=\"text\" name=\"seller_id\" id=\"seller_loginProduct\"><br>\n" +
