    ...
    <div class="row">
        <form:form modelAttribute="student" class="col s12" method="post">
            ...
            <div class="row">
                ...
                <div class="input-field col s6">
                    <form:checkbox value="ok" path="isWarden" cssStyle="opacity: 1; pointer-events: auto" class="validate"  /><!--cssStyle="border: black 1px solid; color: black; height: 15px; width: 15px"-->
                    <form:label path="isWarden">Warden</form:label>
                    <form:errors path="isWarden" class="error-text helper-text" data-error="wrong" data-success="right"/>
                </div>
            </div>
