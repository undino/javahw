...
<div class="container">
    ...
    <div class="row">
        <form:form modelAttribute="studentDto" class="col s12" method="post" enctype="multipart/form-data">
            <form:hidden path="id"/>
            <div class="row">
            ...
            <div class="row">
                <div class="input-field col s6">
                    <input type="file" id="img" name="img" class="validate" value="Upload" placeholder="Upload avatar"/>
                </div>
            </div>
            <div class="row">
                <div class="input-field col s6">
