...
-- кодировка важна!
create database if not exists cinemadb default character set utf8;
use cinemadb;
create table if not exists Genres (
  -- для primary key автоматически  not null unique
...
insert Movies (
    ...
    2013,
    4,
    "История блюстителя закона Джона Рейда, который с помощью индейца Тон",
    "02:55:13"
  ),
  (
    1,
    ...
    2019,
    5,
    "Генри Броган, первоклассный киллер, становится мишенью таинственного оперативник",
    "01:57:06"
  ),
  (
    2,
